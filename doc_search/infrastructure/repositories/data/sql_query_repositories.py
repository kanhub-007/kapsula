...
from doc_search.core.domain.entities.chunk import Chunk as DomainChunk
from doc_search.core.domain.entities.library_card import LibraryCard as DomainCard
from doc_search.core.domain.entities.sub_document import SubDocument as DomainSubDoc
from doc_search.core.domain.interfaces.query_repositories import (
    ChunkRepository,
