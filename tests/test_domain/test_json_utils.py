...
``parse_json_safely`` (parse clean/fenced/prose-wrapped JSON; return {} on
...
class TestParseJsonSafely:
    """Black-box contract tests for parse_json_safely."""

    def test_clean_json_object(self):
        """A well-formed JSON object is returned unchanged."""
        assert parse_json_safely('{"a": 1, "b": "x"}') == {"a": 1, "b": "x"}
    ...
    def test_fenced_json_block(self):
        ...
        assert parse_json_safely(text) == {"topics": [1, 2]}
    ...
    def test_prose_wrapped_json(self):
        ...
        assert parse_json_safely(text) == {"plan": "go"}
    ...
    def test_trailing_comma_in_nested_list(self):
        ...
        assert parse_json_safely('{"items": [1, 2, 3,]}') == {"items": [1, 2, 3]}
    ...
    def test_garbage_returns_empty_dict(self):
        ...
        assert parse_json_safely("totally not json at all") == {}
    ...
    def test_nested_objects(self):
        ...
        result = parse_json_safely('{"outer": {"inner": [1, {"x": 2}]}}')
