...
def _get_chat_client():
    def _create():
        from kapsula.startup import create_chat_client
...
def _get_query_planner():
    def _create():
        from kapsula.startup import create_query_planner
...
def _get_reranker():
    def _create():
        from kapsula.startup import create_reranker
...
def _get_intelligent_searcher():
    def _create():
        from kapsula.startup import create_intelligent_searcher
...
def _get_search_job_manager():
    def _create():
        from kapsula.presentation.mcp.search_jobs import SearchJobManager
