...
def _memory_guide_text() -> str:
    ...
    return (
        ...
        "  • run_collection_maintenance(collection_id) — regenerate summary, rebuild indexes, "
        "    AND run the consolidation engine to generate topic/evolution/gap cards\n"
        ...
        "    previews. Use this FIRST to understand what topics exist, then formulate "
        "    a targeted query. This is the core workflow — browse before search. "
        "    Optional: filter by level or document_job_id.\n"
        ...
        "then formulate a targeted query — this is the single most important workflow.\n"
        ...
        "  • After uploading documents, run run_collection_maintenance() to generate summaries, "
        "    rebuild indexes, and create topic cards via consolidation.\n"
