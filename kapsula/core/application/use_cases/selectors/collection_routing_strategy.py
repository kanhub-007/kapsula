...
def make_collection_routing_strategy(
    ...
    from kapsula.core.application.use_cases.selectors.auto_collection_routing_strategy import (
    ...
    from kapsula.core.application.use_cases.selectors.llm_collection_routing_strategy import (
